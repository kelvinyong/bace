(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      prevWeek : function() {
         ...
         var now = new Date();
         if(!(newDate < now.setMonth(now.getMonth()-3))){
        	 this._clearCalendar();
      ...
      _renderCalendar : function() {
         ...
         for (var i = start; i < end; i++) {
            ...
            if (options.use24Hour) {
               calendarBodyHtml += "<div class=\"wc-time-header-cell\">" + self._24HourForIndex(i) + " - " + self._24HourForIndex(i+1) + "</div>";
            } else {
               calendarBodyHtml += "<div class=\"wc-time-header-cell\">" + self._hourForIndex(i) + "<span class=\"wc-am-pm\">" + self._amOrPm(i) + "</span>-" + self._hourForIndex(i+1) + "<span class=\"wc-am-pm\">" + self._amOrPm(i+1) + "</span></div>";
            }
      ...
      _setupEventCreationForWeekDay : function($weekDay) {
         ...
         $weekDay.mousedown(function(event) {
            ...
            if ($target.hasClass("wc-day-column-inner")) {
               ...
               $newEvent.css({lineHeight: (options.timeslotHeight - 3) + "px", fontSize: (options.timeslotHeight / 3) + "px"});
      ...
      _renderEvent: function (calEvent, $weekDay) {
         ...
         $calEvent.css({lineHeight: (options.timeslotHeight - 3) + "px", fontSize: (options.timeslotHeight / 3) + "px"});
      ...
      _refreshEventDetails : function(calEvent, $calEvent) {
         ...
         $calEvent.find(".wc-title").html(calEvent.servicetype);//KELVIN
